...
class HomePageState extends State<HomePage> {
  ...
  Widget buildDrawerContent() => HeaderList(
    [
  ...
  Widget buildEndDrawer() => SimpleClipPathDrawer(
    ...
    child: buildEndDrawerContent(),
  );

  Widget buildEndDrawerContent() => SafeArea(
      child: ProfileScreen(
  ...
  Widget buildOnboardingPage() => const OnboardingScreen(
    title: "A Title",
